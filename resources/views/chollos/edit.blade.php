...
@section('title', 'Editar Chollo - ░▒▓ Severo')
    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-pencil-square"></i> Editar Chollo</h4>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('chollos.update', $chollo) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('titulo') is-invalid @enderror" 
                               ...
                               value="{{ old('titulo', $chollo->titulo) }}" required>
                        @error('titulo')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                  id="descripcion" name="descripcion" rows="4" required>{{ old('descripcion', $chollo->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('url') is-invalid @enderror" 
                               id="url" name="url" 
                               value="{{ old('url', $chollo->url) }}" required>
                        @error('url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('categoria') is-invalid @enderror" 
                                   ...
                                   value="{{ old('categoria', $chollo->categoria) }}" required>
                            @error('categoria')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('puntuacion') is-invalid @enderror" 
                                   ...
                                   value="{{ old('puntuacion', $chollo->puntuacion) }}" min="0" max="10" required>
                            @error('puntuacion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('precio') is-invalid @enderror" 
                                   ...
                                   value="{{ old('precio', $chollo->precio) }}" min="0" step="0.01" required>
                            @error('precio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('precio_descuento') is-invalid @enderror" 
                                   ...
                                   value="{{ old('precio_descuento', $chollo->precio_descuento) }}" min="0" step="0.01" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('disponible') is-invalid @enderror" 
                            ...
                            <option value="1" {{ old('disponible', $chollo->disponible) == '1' ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ old('disponible', $chollo->disponible) == '0' ? 'selected' : '' }}>No</option>
                        </select>
                        @error('disponible')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Actualizar Chollo
                        </button>
